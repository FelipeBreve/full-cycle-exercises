package com.felipe.catalogo.video;
...
//        extends UnitTest
{
    ...
    public void givenInvalidParams_whenCallsWith_ShouldReturnError() {
        Assertions.assertThrows(
                ...
                () -> AudioVideoMedia.with(
                        null,
                        "131", "Random", "/videos", "/videos", MediaStatus.PENDING)
        );
        ...
        Assertions.assertThrows(
                ...
                () -> AudioVideoMedia.with(
                        "id",
                        "abc", null, "/videos", "/videos", MediaStatus.PENDING)
        );
        ...
        Assertions.assertThrows(
                ...
                () -> AudioVideoMedia.with(
                        "id",
                        "abc", "Random", null, "/videos", MediaStatus.PENDING)
        );
        ...
        Assertions.assertThrows(
                ...
                () -> AudioVideoMedia.with(
                        "id",
                        "abc", "Random", "/videos", null, MediaStatus.PENDING)
        );
