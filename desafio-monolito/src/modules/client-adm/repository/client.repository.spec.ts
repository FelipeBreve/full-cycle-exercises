...
describe("Client Repository test", () => {
  ...
  it("should find a client", async () => {
    ...
    expect(formatarData(result.createdAt)).toStrictEqual(formatarData(client.createdAt));
    expect(formatarData(result.updatedAt)).toStrictEqual(formatarData(client.updatedAt));
  })
})